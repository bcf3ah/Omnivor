...
//==============================================================================
//ASSOCIATIONS AND HELPER METHODS
//==============================================================================
//Associate Perspectives with User (user should be the current user from context!)
userSchema.statics.addPerspective = function(user, content, topicId, createdAt) {
    const that = this;
    const id = user.id;
    const firstName = user.firstName;
    const lastName = user.lastName;
    return Perspective.create({content, topicId, createdAt}, function(err, perspective){
      if(err){
        console.log(err);
      } else {
...
userSchema.statics.addTopic = function(user, title, question, imageURL, createdAt) {
    const that = this;
    const id = user.id;
    const firstName = user.firstName;
    const lastName = user.lastName;
